...
namespace Ims.Case.Controllers
{
    ...
    public partial class CFLicensesController : ControllerBase
    {
        private readonly ICaseApiSupervisor _supervisor;

        public CFLicensesController(ICaseApiSupervisor supervisor)
        {
        ...
        public async Task<IActionResult> GetCFLicenseAsync(
            [SwaggerParameter(
        ...
        {
            var retVal = await _supervisor.GetCFLicenseByIdAsync(sourcedId, ct);
            if (retVal == null)
            {
