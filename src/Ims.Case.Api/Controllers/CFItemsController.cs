...
namespace Ims.Case.Controllers
{
    ...
    public partial class CFItemsController : ControllerBase
    {
        private readonly ICaseApiSupervisor _supervisor;

        public CFItemsController(ICaseApiSupervisor supervisor)
        {
        ...
        public async Task<IActionResult> GetCFItemAsync(
            [SwaggerParameter(
        ...
        {
            var retVal = await _supervisor.GetCFItemByIdAsync(sourcedId, ct);
            if (retVal == null)
            {
