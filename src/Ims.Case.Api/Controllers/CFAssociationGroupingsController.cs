...
namespace Ims.Case.Controllers
{
    ...
    public partial class CFAssociationGroupingsController : ControllerBase
    {
        private readonly ICaseApiSupervisor _supervisor;

        public CFAssociationGroupingsController(ICaseApiSupervisor supervisor)
        {
        ...
        [SwaggerResponse(
            ...
            type: typeof(CFAssociationGrouping))]
        [SwaggerResponse(
        ...
        public async Task<IActionResult> GetCFAssociationGroupingAsync(
            [SwaggerParameter(
