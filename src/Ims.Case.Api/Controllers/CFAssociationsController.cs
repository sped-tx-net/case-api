...
namespace Ims.Case.Controllers
{
    ...
    public partial class CFAssociationsController : ControllerBase
    {
        private readonly ICaseApiSupervisor _supervisor;

        public CFAssociationsController(ICaseApiSupervisor supervisor)
        {
        ...
        public async Task<IActionResult> GetCFAssociationAsync(
            [SwaggerParameter(
        ...
        {
            var retVal = await _supervisor.GetCFAssociationByIdAsync(sourcedId, ct);
            if (retVal == null)
            {
