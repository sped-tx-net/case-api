...
namespace Ims.Case.Controllers
{
    ...
    public partial class CFItemTypesController : ControllerBase
    {
        private readonly ICaseApiSupervisor _supervisor;

        public CFItemTypesController(ICaseApiSupervisor supervisor)
        {
        ...
        public async Task<IActionResult> GetCFItemTypeAsync(
            [SwaggerParameter(
        ...
        {
            var retVal = new CFItemTypeSet();
            var itemType = await _supervisor.GetCFItemTypeByIdAsync(sourcedId, ct);
            if (itemType != null)
                retVal.CFItemTypes.Add(itemType);
